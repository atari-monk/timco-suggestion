...
{
    private const string SignInUri = "/MicrosoftIdentity/Account/SignIn";
    ...
    private void LoadCreatePage()
    {
        ...
        {
            navManager.NavigateTo(SignInUri, true);
        }
    }
    ...
    private async Task LoadAndVerifyUser()
    {
        ...
        if (string.IsNullOrWhiteSpace(objectId) == false)
        {
            ...
            var fisrstName = authState.User.Claims.FirstOrDefault(c => c.Type.Contains("givenname"))?.Value;
            ...
            if (fisrstName.Equals(loggedInUser.FirstName) == false)
            {
                isDirty = true;
                loggedInUser.FirstName = fisrstName;
            }
    ...
    private string GetSuggestionStatusClass(SuggestionModel suggestion)
    {
        ...
        {
        "Completed" => "suggestion-entry-status-completed", "Watching" => "suggestion-entry-status-watching", "Upcoming" => "suggestion-entry-status-upcoming", "Dismissed" => "suggestion-entry-status-dismissed", _ => "suggestion-entry-status-none"
        }
