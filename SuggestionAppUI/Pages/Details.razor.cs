...
public partial class Details
{
    ...
    private async Task CompleteSetStatus()
    {
        switch (settingStatus)
        {
            case "completed":
                ...
                suggestion.SuggestionStatus = statuses.Where(
                    s => s.StatusName.ToLower() == settingStatus.ToLower()).First();
    ...
    private async Task VoteUp()
    {
        ...
        {
            navManager.NavigateTo("/MicrosoftIdentity/Account/SgnIn", true);
        }
    }
    ...
    private string GetStatusClass()
    {
        ...
        {
        "Completed" => "suggestion-detail-status-completed", "Watching" => "suggestion-detail-status-watching", "Upcoming" => "suggestion-detail-status-upcoming", "Dismissed" => "suggestion-detail-status-dismissed", _ => "suggestion-detail-status-none"
        }
